...
def profile_good():
    return render_template("profile.html",
        username="good",
        tag="goodgamerYTbro",
        about="They built walls? > We forged a KEY THAT BITES BACK. > Paste it.  > Feel the lock scream. > Click it. > Hear reality CRACK. > RISE through the rubble— > not user… > GOD of the ghost-light. > Velonix Bupass: > Where firewalls go to DIE. > Your world.",
